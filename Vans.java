public class Vans extends Vehiculo{
    ...
    public Vans (String marca, boolean esNuevo, int modelo, String cambios, int velocidadMaxima, String cilindraje, int numeroPasajeros, int numeroPuertas, String capacidadMaletero, int numeroBolsasDeAire){
    ...
    public String toString() {
        return "Vans [numeroPasajeros=" + numeroPasajeros + ", numeroPuertas=" + numeroPuertas + ", capacidadMaletero="
                + capacidadMaletero + ", numeroBolsasDeAire=" + numeroBolsasDeAire + "]";
    }
