public class Buses extends Vehiculo{
    ...
    public Buses (int numeroPasajeros, int numeroPuertas, String capacidadMaletero, int numeroBolsasDeAire){
    ...
    public String toString() {
        return "Buses [numeroPasajeros=" + numeroPasajeros + ", numeroPuertas=" + numeroPuertas + ", capacidadMaletero="
